...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:/Users/cmsmcq/2021/gingersnap/src/ixml-to-rk-subset.xsl"/>
   ...
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/cmsmcq/2021/gingersnap/tests/ixml-to-rk-subset.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/Users/cmsmcq/2021/gingersnap/tests/ixml-to-rk-subset.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/Users/cmsmcq/2021/gingersnap/src/ixml-to-rk-subset.xsl</xsl:attribute>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:context-item use="absent"/>
      <xsl:message>Test r_k subset generation</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario1</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/Users/cmsmcq/2021/gingersnap/tests/ixml-to-rk-subset.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>Test r_k subset generation</xsl:text>
         </xsl:element>
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="xsp:context" namespace="http://www.jenitennison.com/xslt/xspec">
               ...
               <xsl:attribute name="href" namespace="">file:/Users/cmsmcq/2021/gingersnap/tests/xml/a.pc.ixml.xml</xsl:attribute>
               <xsl:attribute name="mode" namespace="">rk-subset</xsl:attribute>
               <xsl:element name="xsp:param" namespace="http://www.jenitennison.com/xslt/xspec">
                  <xsl:namespace name="ws">http://www.blackmesatech.com/2021/nss/ws</xsl:namespace>
                  <xsl:namespace name="xs">http://www.w3.org/2001/XMLSchema</xsl:namespace>
                  <xsl:attribute name="name" namespace="">k</xsl:attribute>
                  <xsl:attribute name="tunnel" namespace="">yes</xsl:attribute>
                  <xsl:attribute name="select" namespace="">xs:integer(2)</xsl:attribute>
               </xsl:element>
               <xsl:element name="xsp:param" namespace="http://www.jenitennison.com/xslt/xspec">
                  <xsl:namespace name="ws">http://www.blackmesatech.com/2021/nss/ws</xsl:namespace>
                  <xsl:namespace name="xs">http://www.w3.org/2001/XMLSchema</xsl:namespace>
                  <xsl:attribute name="name" namespace="">config</xsl:attribute>
                  <xsl:attribute name="tunnel" namespace="">yes</xsl:attribute>
                  <xsl:attribute name="select" namespace=""> 'no-config-file' </xsl:attribute>
               </xsl:element>
            </xsl:element>
         </xsl:element>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d50e0-doc"
                       as="document-node()"
                       select="doc('file:/Users/cmsmcq/2021/gingersnap/tests/xml/a.pc.ixml.xml')"/>
         <xsl:variable name="Q{urn:x-xspec:compile:impl}context-d50e0"
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            ...
            <xsl:variable xmlns:xsp="http://www.jenitennison.com/xslt/xspec"
                          ...
                          xmlns:ws="http://www.blackmesatech.com/2021/nss/ws"
                          name="Q{}config"
                          select=" 'no-config-file' "/>
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d50e0" mode="Q{}rk-subset">
               <xsl:with-param xmlns:xsp="http://www.jenitennison.com/xslt/xspec"
                               xmlns:xs="http://www.w3.org/2001/XMLSchema"
                               xmlns:ws="http://www.blackmesatech.com/2021/nss/ws"
                               name="Q{}k"
                               select="$Q{}k"
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d49e9" select="()"><!--expected result--></xsl:variable>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:message terminate="yes">ERROR in xsp:expect ('Test r_k subset generation Number of rules should not shrink'): Non-boolean @test must be accompanied by @as, @href, @select, or child node.</xsl:message>
            </xsl:otherwise>
         </xsl:choose>
      </xsl:variable>
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d49e9"/>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect2"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result" required="yes"/>
      <xsl:message/>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d49e10-doc"
                    as="document-node()"
      ...
      <xsl:variable xmlns:xsp="http://www.jenitennison.com/xslt/xspec"
                    ...
                    select="$Q{urn:x-xspec:compile:impl}expect-d49e10-doc ! ( ws:strip(ixml/rule, $strip, $keep) )"><!--expected result--></xsl:variable>
      <!-- wrap $x:result into a document node if possible -->
      <xsl:variable name="Q{urn:x-xspec:compile:impl}test-items" as="item()*">
         <xsl:choose>
            <xsl:when test="exists($Q{http://www.jenitennison.com/xslt/xspec}result) and Q{http://www.jenitennison.com/xslt/xspec}wrappable-sequence($Q{http://www.jenitennison.com/xslt/xspec}result)">
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
         ...
         <xsl:choose>
            <xsl:when test="$Q{urn:x-xspec:compile:impl}boolean-test">
               <xsl:message terminate="yes">ERROR in xsp:expect ('Test r_k subset generation'): Boolean @test must not be accompanied by @as, @href, @select, or child node.</xsl:message>
            </xsl:when>
            <xsl:otherwise>
               <xsl:sequence select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d49e10, $Q{urn:x-xspec:compile:impl}test-result, '')"/>
            </xsl:otherwise>
         </xsl:choose>
      </xsl:variable>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
