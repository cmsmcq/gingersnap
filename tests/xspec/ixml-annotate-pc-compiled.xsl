...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <xsl:import href="file:/Users/cmsmcq/2021/gingersnap/src/ixml-annotate-pc.xsl"/>
   <!-- XSpec library modules providing tools -->
   <xsl:include href="file:/home2/ex/xspec/xspec/src/common/runtime-utils.xsl"/>
   <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}xspec-uri"
                 as="Q{http://www.w3.org/2001/XMLSchema}anyURI">file:/Users/cmsmcq/2021/gingersnap/tests/ixml-annotate-pc.xspec</xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}main"
      ...
      <xsl:result-document format="Q{{http://www.jenitennison.com/xslt/xspec}}xml-report-serialization-parameters">
         <xsl:element name="report" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:attribute name="xspec" namespace="">file:/Users/cmsmcq/2021/gingersnap/tests/ixml-annotate-pc.xspec</xsl:attribute>
            <xsl:attribute name="stylesheet" namespace="">file:/Users/cmsmcq/2021/gingersnap/src/ixml-annotate-pc.xsl</xsl:attribute>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1"
      ...
      <xsl:context-item use="absent"/>
      <xsl:message>Test PC annotation</xsl:message>
      <xsl:element name="scenario" namespace="http://www.jenitennison.com/xslt/xspec">
         <xsl:attribute name="id" namespace="">scenario1</xsl:attribute>
         <xsl:attribute name="xspec" namespace="">file:/Users/cmsmcq/2021/gingersnap/tests/ixml-annotate-pc.xspec</xsl:attribute>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>Test PC annotation</xsl:text>
         </xsl:element>
         <xsl:element name="input-wrap" namespace="">
            <xsl:element name="xsp:context" namespace="http://www.jenitennison.com/xslt/xspec">
               ...
               <xsl:attribute name="mode" namespace="">annotate-pc</xsl:attribute>
            </xsl:element>
         </xsl:element>
         ...
         <xsl:variable name="Q{http://www.jenitennison.com/xslt/xspec}result" as="item()*">
            <xsl:apply-templates select="$Q{urn:x-xspec:compile:impl}context-d48e0"
                                 mode="Q{}annotate-pc"/>
         </xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect1"
      ...
      <xsl:message>All rules should remain in output</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d47e5" select="()"><!--expected result--></xsl:variable>
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:message terminate="yes">ERROR in xsp:expect ('Test PC annotation All rules should remain in output'): Non-boolean @test must be accompanied by @as, @href, @select, or child node.</xsl:message>
            </xsl:otherwise>
         </xsl:choose>
      </xsl:variable>
   ...
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect2"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}context" required="yes"/>
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result" required="yes"/>
      <xsl:message>All RHS should remain in output</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d47e6" select="()"><!--expected result--></xsl:variable>
      <!-- wrap $x:result into a document node if possible -->
      <xsl:variable name="Q{urn:x-xspec:compile:impl}test-items" as="item()*">
         <xsl:choose>
            <xsl:when test="exists($Q{http://www.jenitennison.com/xslt/xspec}result) and Q{http://www.jenitennison.com/xslt/xspec}wrappable-sequence($Q{http://www.jenitennison.com/xslt/xspec}result)">
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
         ...
         <xsl:choose>
            ...
            <xsl:otherwise>
               <xsl:message terminate="yes">ERROR in xsp:expect ('Test PC annotation All RHS should remain in output'): Non-boolean @test must be accompanied by @as, @href, @select, or child node.</xsl:message>
            </xsl:otherwise>
         </xsl:choose>
      </xsl:variable>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:attribute name="successful"
                        ...
                        select="$Q{urn:x-xspec:compile:impl}successful"/>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>All RHS should remain in output</xsl:text>
         </xsl:element>
         <xsl:element name="expect-test-wrap" namespace="">
            <xsl:element name="xsp:expect" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:namespace name="functx">http://www.functx.com</xsl:namespace>
               <xsl:attribute name="test" namespace="">count(/ixml/rule/alt) = 2</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:if test="not($Q{urn:x-xspec:compile:impl}boolean-test)">
            <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d47e6"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
   <xsl:template name="Q{http://www.jenitennison.com/xslt/xspec}scenario1-expect3"
      ...
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}context" required="yes"/>
      <xsl:param name="Q{http://www.jenitennison.com/xslt/xspec}result" required="yes"/>
      <xsl:message>Annotation should label recursive nonterminals.</xsl:message>
      <xsl:variable name="Q{urn:x-xspec:compile:impl}expect-d47e7-doc"
                    as="document-node()"
                    select="doc('file:/Users/cmsmcq/2021/gingersnap/tests/xml/a.pc.ixml.xml')"/>
      <xsl:variable xmlns:xsp="http://www.jenitennison.com/xslt/xspec"
                    xmlns:functx="http://www.functx.com"
                    name="Q{urn:x-xspec:compile:impl}expect-d47e7"
                    select="$Q{urn:x-xspec:compile:impl}expect-d47e7-doc ! ( ixml/rule )"><!--expected result--></xsl:variable>
      <!-- wrap $x:result into a document node if possible -->
      <xsl:variable name="Q{urn:x-xspec:compile:impl}test-items" as="item()*">
         <xsl:choose>
            <xsl:when test="exists($Q{http://www.jenitennison.com/xslt/xspec}result) and Q{http://www.jenitennison.com/xslt/xspec}wrappable-sequence($Q{http://www.jenitennison.com/xslt/xspec}result)">
      ...
      <xsl:variable name="Q{urn:x-xspec:compile:impl}successful"
         ...
         <xsl:choose>
            <xsl:when test="$Q{urn:x-xspec:compile:impl}boolean-test">
               <xsl:message terminate="yes">ERROR in xsp:expect ('Test PC annotation Annotation should label recursive nonterminals.'): Boolean @test must not be accompanied by @as, @href, @select, or child node.</xsl:message>
            </xsl:when>
            <xsl:otherwise>
               <xsl:sequence select="Q{urn:x-xspec:common:deep-equal}deep-equal($Q{urn:x-xspec:compile:impl}expect-d47e7, $Q{urn:x-xspec:compile:impl}test-result, '')"/>
            </xsl:otherwise>
         </xsl:choose>
      </xsl:variable>
      <xsl:if test="not($Q{urn:x-xspec:compile:impl}successful)">
      ...
      <xsl:element name="test" namespace="http://www.jenitennison.com/xslt/xspec">
         ...
         <xsl:attribute name="successful"
                        ...
                        select="$Q{urn:x-xspec:compile:impl}successful"/>
         <xsl:element name="label" namespace="http://www.jenitennison.com/xslt/xspec">
            <xsl:text>Annotation should label recursive nonterminals.</xsl:text>
         </xsl:element>
         <xsl:element name="expect-test-wrap" namespace="">
            <xsl:element name="xsp:expect" namespace="http://www.jenitennison.com/xslt/xspec">
               <xsl:namespace name="functx">http://www.functx.com</xsl:namespace>
               <xsl:attribute name="test" namespace="">ixml/rule</xsl:attribute>
            </xsl:element>
         </xsl:element>
         <xsl:if test="not($Q{urn:x-xspec:compile:impl}boolean-test)">
            <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
         ...
         <xsl:call-template name="Q{urn:x-xspec:common:report-sequence}report-sequence">
            <xsl:with-param name="sequence" select="$Q{urn:x-xspec:compile:impl}expect-d47e7"/>
            <xsl:with-param name="report-name" select="'expect'"/>
         </xsl:call-template>
      </xsl:element>
   </xsl:template>
